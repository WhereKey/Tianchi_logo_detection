...
if __name__ == '__main__':
    annFile = '/Users/caimogudexiaoxilao/data/myCode/Tianchi/CBNetV2-main/EDA/round2/train/annotations/instances_train2017.json'     # coco格式的标注文件
    clusters = 6                                          # anchor数量（期望的长宽比例数）
